package com.safeshare.sid.safeshare;
 ...
 *
 */
public class SDcardMainActivity extends Activity implements OnItemClickListener {
    ...
    private void setupViews() {
        ...
        // sdcardImages.setNumColumns(display.getWidth()/95); //Sidhanth here it was 95
        sdcardImages.setClipToPadding(false);
        sdcardImages.setOnItemClickListener(SDcardMainActivity.this);
    ...
    class ImageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            imageView.setPadding(10, 10, 10, 10);//sidhanth this was 8,8,8,8
